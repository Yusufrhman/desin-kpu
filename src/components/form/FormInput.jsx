    ...
    >
      ...
      <div className="w-full h-full relative text-left ">
        ...
        <input
          ...
          className={`bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-slate-600 focus:border-primary-600 block w-full p-2.5 text-left  ${
